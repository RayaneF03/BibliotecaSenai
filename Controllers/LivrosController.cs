...
namespace BibliotecaSenai.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LivroId,Titulo,Autor,Genero,AnoPublicacao,Editora,Disponivel")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LivroId,Titulo,Autor,Genero,AnoPublicacao,Editora,Disponivel")] Livro livro)
        {
            if (id != livro.LivroId)
            {
                return NotFound();
